...
app.controller('loginControl',function($scope,$scope,$location,user, $http){
    ...
    $scope.loginmain=function()
    {
        ...
        var newurl="https://anpr-system.herokuapp.com/anpr/session/"+$scope.loguname+"/"+$scope.logpassword+"/"+choi;
        console.log(newurl);
...
app.controller('showexceptcontrol',function($scope,$window,$location,user,$http,$interval)
{
 
    $scope.getExceptData=function()
    {
        console.log("function");
        $http.get("https://anpr-system.herokuapp.com/anpr/getalltolldata").then(
            function(response){
...
app.controller('tollControl',function($scope,$location,user,$http,$interval)
{
    ...
    {
        var url="https://anpr-system.herokuapp.com/anpr/gettolldatabycode/"+$scope.id.toString();
        $http.get(url).then(
            function(response){
    ...
    {
        var url="https://anpr-system.herokuapp.com/anpr/inserttolldata";
    ...
    {
        var url="https://anpr-system.herokuapp.com/anpr/addtollrecord";
        url += "/"+$scope.id.toString();
    ...
    $scope.refresh=function(){
        $http.get("https://anpr-system.herokuapp.com/anpr/getalltollrecorddata").then(
            function(response){
            $scope.datax=response.data;
            });
    ...
    $scope.edit=function()
    {
        var url="https://anpr-system.herokuapp.com/anpr/updatetollrecord";
    ...
    {
        console.log($scope.id);
        var url="https://anpr-system.herokuapp.com/anpr/deletetollrecord";
...
app.controller('testControl',function($scope,$location,user,$http,$interval){
    ...
    {
        $http.get("https://anpr-system.herokuapp.com/anpr/getnocfile/"+id.toString(),{ responseType: 'arraybuffer' })
  .then(function(response) {
    ...
    {
        $http.get("https://anpr-system.herokuapp.com/anpr/getallcardata/"+$scope.id.toString()).then(
        function(response){
    ...
    $scope.refresh=function(){
        ...
        $http.get("https://anpr-system.herokuapp.com/anpr/getall").then(
        function(response){
        $scope.data=response.data;
        });

        
        $http.get("https://anpr-system.herokuapp.com/anpr/getalllogin").then(
        function(response){
    ...
    $scope.terminateDelete=function()
    {
        ...
        $scope.delete=function(sId){
            ...
            console.log(sId);
            var newUrl="https://anpr-system.herokuapp.com/anpr/delete/"+sId.toString();
            console.log(newUrl);
            $http.get(newUrl).then(
                function(response){
                $scope.data=response.data;
            ...
            $scope.editinit=function(sId){
                ...
                console.log(sId);
                var newUrl="https://anpr-system.herokuapp.com/anpr/get/"+sId.toString();
                console.log(newUrl);
                $http.get(newUrl).then(
                    function(response2){
    ...
    $scope.update=function(){
        ...
        var newUrl="https://anpr-system.herokuapp.com/anpr/update/";
    ...
    $scope.insert=function(){
        ...
        console.log($scope.mobile.toString());
        console.log($scope.license.toString());
        var newUrl="https://anpr-system.herokuapp.com/anpr/insert/";
    ...
    $scope.submitregister=function()
    {
        ...
        var newUrl="https://anpr-system.herokuapp.com/anpr/insertlogin/";
...
app.controller('userControl',function($scope,$window,$location,user,$http,$interval){
  ...
  .then(function(response) {
    ...
    $scope.refresh=function(){
        ...
        $http.get("https://anpr-system.herokuapp.com/anpr/getallbyname/"+localStorage.getItem('username')).then(
        function(response){
        $scope.data=response.data;
        });
    ...
    $scope.payToll=function()
    {
        ...
        // $http.get("https://anpr-system.herokuapp.com/anpr/removetoll/"+$scope.getCar.toString()+"/"+$scope.toll+"/"+$scope.loggedinas).then(
        //     function(response){
        //     $scope.data=response.data;
        //     console.log($scope.data3);
        //     });
    ...
    $scope.terminateDelete=function()
    {
        ...
        $scope.delete=function(sId){
            ...
            {
                var newUrl="https://anpr-system.herokuapp.com/anpr/deleteuser/"+sId.toString()+"/"+$scope.loggedinas;
            console.log(newUrl);
            $http.get(newUrl).then(
                function(response){
                $scope.data=response.data;
    ...
    $scope.update=function(){
        ...
        console.log($scope.mobile.toString());
        console.log($scope.license.toString());
        var newUrl="https://anpr-system.herokuapp.com/anpr/updateuser/";
    ...
    $scope.insert=function(){
        ...
        console.log($scope.mobile.toString());
        console.log($scope.license.toString());
        var newUrl="https://anpr-system.herokuapp.com/anpr/insertuser/";
